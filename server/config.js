...
/**
 * Todo lo estático vive en `public/`: Vercel lo sirve desde su CDN sin pasar
 * por la función. En local lo sirve el propio servidor con la misma ruta, así
 * que las URLs son idénticas en los dos entornos.
 */
...
/** En producción la cookie de sesión debe viajar sólo por HTTPS. */
export const IS_PROD = process.env.VERCEL === '1' || process.env.NODE_ENV === 'production';
