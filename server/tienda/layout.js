...
/* cabecera */
/* Blanco opaco, no translúcido.
   El logotipo es un PNG sin transparencia: un rectángulo blanco con las letras
   encima. Con la cabecera al 93% sobre el crema de la portada, ese rectángulo
   quedaba un punto más claro que la barra y se veía el recuadro. */
...
/* El multiply es de refuerzo: sobre blanco no cambia nada, y si algún día la
   barra deja de ser blanca el recuadro sigue sin aparecer. Es seguro porque la
   cabecera ya no es translúcida; con el backdrop-filter se habría mezclado con
   la página que pasa por debajo. */
.hd .marca img{height:42px;width:auto;display:block;mix-blend-mode:multiply}
